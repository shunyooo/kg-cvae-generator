...
kor_corpus_config_path = './config/korean/cvae_corpus.json'
kor_dataset_config_path = './config/korean/cvae_dataset.json'
kor_trainer_config_path = './config/korean/cvae_trainer.json'
...
def main():
    ...
    """
    for output_idx, output_report in enumerate(output_reports):
        if output_idx < 5:
            print(output_report["train"]["output_sents"])
    """
