...
class LongDataLoader(object):
    ...
    def epoch_init(self, batch_size, backward_size, step_size, shuffle=True, intra_shuffle=True):
        ...
        # print("batch_indexes", self.batch_indexes)
        ...
        for idx, b_ids in enumerate(self.batch_indexes):
            ...
            # print("num_seg", num_seg, "batch_idx", b_ids, "temp_num_batch", temp_num_batch, "data_size", self.data_size)

            if num_seg > 0:
                cut_start = list(range(0, num_seg*self.step_size, step_size))
                # print("cut_start", cut_start)
                cut_end = list(range(self.backward_size, num_seg*self.step_size+self.backward_size, step_size))
                ...
                cut_end = list(range(2, self.backward_size)) + cut_end
                # print("cut_start", cut_start, "cut_end", cut_end)
